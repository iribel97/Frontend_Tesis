...
export class OpAdminService {
    ...
    deleteCurso(id: number): Observable<any> {
        return this.http.delete<any>(`${this.apiUrl}/api/adminop/curso/${id}`);
    }

    // editar un curso
    editCurso(requestBody: any): Observable<any> {
        return this.http.put<any>(this.apiUrl + "/api/adminop/curso", requestBody);
    }
